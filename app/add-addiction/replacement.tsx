                    ...
                    <View style={{
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <InfoCircle color={Colors.disabled} width={25} height={25} strokeWidth={3} />
                            </TouchableOpacity>
                        </View>
                        <Button title="Chewing Gum" onPress={() => { }} color="pink" textColor="white" />
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <View
                                ...
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <Refresh color={Colors.darkGray} width={20} height={20} strokeWidth={3} />
                                </TouchableOpacity>
                        ...
                        <Button title="Eating Dark Chocolate" onPress={() => { }} color="purple" textColor="white" />

                        <View style={{ height: 10 }} />

                        <Button title="I have a better idea..." onPress={() => {
                            router.push("/add-addiction/customize");
